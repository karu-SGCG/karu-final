...
public class TiposArticulos extends javax.swing.JDialog {
    public TiposArticulos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        sessionHibernate();
        arranque();
        setLocationRelativeTo(null);
        this.setTitle("Mantenimiento de Tipos de Articulos - KARU v1.0");
        this.usuario = "karu";
        this.formulario = this.getClass().getSimpleName();
    }
    
        public TiposArticulos(String user) {
        initComponents();
        sessionHibernate();
        arranque();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipos de Artículos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiposArticulos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TiposArticulos dialog = new TiposArticulos(new javax.swing.JFrame(), true);
    ...
    public void eliminar(){
        ...
        if(seleccion == 1){//Comparamos la selección del usuario igual a 1 no eliminamos, si es diferente se elimina.
            ...
            MtTiposArticulos p = (MtTiposArticulos) st.load(MtTiposArticulos.class, idTipo);//Hacemos un load pasando como argumento la clase Tipo y  el Id del mismo...
    ...
    public void guardar(){
        if(this.txtDesc.getText().isEmpty()){
            ...
            st.beginTransaction();
            MtTiposArticulos p = new MtTiposArticulos();
            p.setCodTipoArticulo(Integer.parseInt(this.txtId.getText()));
            p.setNomTipoArticulo(this.txtDesc.getText());
    ...
    private void guardarEd(){
        if(this.txtDesc.getText().isEmpty()){
            ...
            MtTiposArticulos p = (MtTiposArticulos) st.load(MtTiposArticulos.class, idTipo);
            p.setNomTipoArticulo(this.txtDesc.getText());
            p.setAccionMod(accion);
            p.setUsuarioMod(usuario);
            Calendar cal = Calendar.getInstance();
    ...
    private String obtenerID(){
        ...
        retorno = null;
        try {
            String sql = "SELECT MAX(codTipoArticulo) FROM MtTiposArticulos";
    ...
    public void cargarTabla(){
        st.beginTransaction();
        List<MtTiposArticulos> lista = (List<MtTiposArticulos>)st.createQuery("From MtTiposArticulos order by codTipoArticulo").list();
        for (MtTiposArticulos laLista : lista) {
            model.addRow(new Object[]{
                laLista.getCodTipoArticulo(), laLista.getNomTipoArticulo()
            });
        }
    }
    ...
    public void obtenerTabla(){
        ...
        Object descripcion = model.getValueAt(selectedRow, 1);
        this.txtId.setText(id.toString());
        this.txtDesc.setText(descripcion.toString());
    ...
    private void informe() {
        try {
            ...
            JasperReport elReporte = (JasperReport)JRLoader.loadObject(ClassLoader.getSystemResource("com/informes/TiposArticulosQ.jasper"));
            JasperPrint imprimir = JasperFillManager.fillReport(elReporte, null, conexion);
            JasperViewer visor = new JasperViewer(imprimir, false);
            visor.setTitle("Listado de Tipos de Articulos.");
