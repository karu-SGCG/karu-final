...
public class TiposImpuestos extends javax.swing.JDialog {
    public TiposImpuestos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        sessionHibernate();
        arranque();
        setLocationRelativeTo(null);
        this.setTitle("Mantenimiento de Tipos de Impuestos - KARU v1.0");        
        this.usuario = "karu";
        this.formulario = this.getClass().getSimpleName();        
    }
    
    public TiposImpuestos(String user) {
        initComponents();
        sessionHibernate();
        arranque();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtPorcentaje, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripción", "Porcentaje", "Activo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiposImpuestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TiposImpuestos dialog = new TiposImpuestos(new javax.swing.JFrame(), true);
    ...
    public void defaultTableModel(){
        ...
        this.jTable1.getColumnModel().getColumn(3).setPreferredWidth(25);
    ...
    public void cargarTabla(){
        st.beginTransaction();
        List<MtTipoImpuestos> lista;
        lista = (List<MtTipoImpuestos>)st.createQuery("From MtTipoImpuestos order by codTipoImpuesto").list();
        for (MtTipoImpuestos laLista : lista) {
            model.addRow(new Object[]{
                laLista.getCodTipoImpuesto(), laLista.getNomTipoImpuesto(),
                laLista.getPorcentaje().toString(), laLista.getEsActivo()
            });
        }
    }
    ...
    public void eliminar(){
        ...
        if(seleccion == 1){
            ...
            MtTipoImpuestos p = (MtTipoImpuestos) st.load(MtTipoImpuestos.class, idTipo);
            st.delete(p);
    ...
    public void guardar(){
        if(this.txtDesc.getText().isEmpty() | this.txtPorcentaje.getText().isEmpty() ){
            JOptionPane.showMessageDialog(null, "Imposible guardar campo vacio.");
        }
        else{
            st.beginTransaction();
            MtTipoImpuestos p = new MtTipoImpuestos();
            p.setCodTipoImpuesto(Integer.parseInt(this.txtId.getText()));
            p.setNomTipoImpuesto(this.txtDesc.getText());
            p.setPorcentaje(BigDecimal.valueOf(Double.parseDouble(this.txtPorcentaje.getText()))  );
    ...
    private String obtenerID(){
        ...
        retorno = null;
        try {
            String sql = "SELECT MAX(codTipoImpuesto) FROM MtTipoImpuestos";
    ...
    private void informe() {
        try {
            ...
            JasperReport elReporte = (JasperReport)JRLoader.loadObject(ClassLoader.getSystemResource("com/informes/Impuestos.jasper"));
            JasperPrint imprimir = JasperFillManager.fillReport(elReporte, null, conexion);
            JasperViewer visor = new JasperViewer(imprimir, false);
            visor.setTitle("Listado de Tipos de Impuestos.");
    ...
    private void consultar() {
        ...
        if (!this.txtId.getText().isEmpty()) {
            ...
            try {
                MtTipoImpuestos elpais = (MtTipoImpuestos)st.get(MtTipoImpuestos.class, Integer.parseInt(cod_busca));
                if ( elpais != null) {
                    //MtTipoImpuestos elpais = (MtTipoImpuestos)st.load(MtTipoImpuestos.class, Integer.parseInt(cod_busca));
                    this.txtId.setText( elpais.getNomTipoImpuesto());
                    this.txtId.setEnabled(false);
                    this.txtId.setEnabled(false);
