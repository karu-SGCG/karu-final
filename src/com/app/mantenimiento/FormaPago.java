...
public class FormaPago extends javax.swing.JDialog {
    ...
    public FormaPago(java.awt.Frame parent, boolean modal) {
        ...
        arranque();
        this.usuario = "karu";
        this.formulario = "FormaPago";
    }

    public FormaPago(String user) {
        setLocationRelativeTo(null);
        initComponents();
        hibernateSession();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento de Forma de Pagos");
        ...
        if (!elimino) {
            ...
            if (selectedRow < 0) {
                JOptionPane.showMessageDialog(null, "Debe seleccionar un registro a eliminar.",
                        "Mantenimiento Forma de Pago", JOptionPane.ERROR_MESSAGE);
            } else {
                ...
                if (showConfirmDialog == 1) {
                    JOptionPane.showMessageDialog(null, "Registro no eliminado.",
                            "Mantenimiento Forma de Pago", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    try {
                        st.beginTransaction();
                        Object valueAt = model.getValueAt(selectedRow, 0);
                        int codForma = Integer.parseInt(valueAt.toString());
                        MtFormaPago registro = (MtFormaPago) st.load(MtFormaPago.class, codForma);
                        st.delete(registro);
                        st.getTransaction().commit();
                        JOptionPane.showMessageDialog(null, "Registro eliminado.", "Mantenimiento Forma de Pago",
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FormaPago dialog = new FormaPago(new javax.swing.JFrame(), true);
    ...
    public void cargarTabla() {
        try {
            List<MtFormaPago> lista = (List<MtFormaPago>) st.createQuery("from MtFormaPago").list();
            for (MtFormaPago areaList : lista) {
                model.addRow(new Object[]{
                    areaList.getCodTipo(), areaList.getDescripcion()});
            }
    ...
    public void guardar() {
        Date fecha = new Date();
            if (this.txtDescripcion.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Ingrese una descripción para la Forma de Pago.",
                        "Mantenimiento Forma de Pago", JOptionPane.INFORMATION_MESSAGE);
                ...
                if (this.origen.equals("Nuevo")) {
                    if (validarId(Integer.parseInt(this.txtCodigo.getText()))) {
                        try {
                            st.beginTransaction();
                            MtFormaPago comp = new MtFormaPago();
                            comp.setCodTipo(Integer.parseInt(this.txtCodigo.getText()));
                    ...
                    try {
                        ...
                        int codArea = Integer.parseInt(this.txtCodigo.getText());
                        
                        MtFormaPago comp = (MtFormaPago) st.load(MtFormaPago.class, codArea);
                        
                        comp.setCodTipo(codArea);
    ...
    private void seleccionarItem() {
        ...
        this.txtCodigo.setText(codArea.toString());
           ...
           JOptionPane.showMessageDialog(null, "Ocurrió un problema al seleccionar item. " + e.getMessage(),
                                "Mantenimiento Forma de Pago", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public boolean validarId(int id) {
        ...
        try {
            MtFormaPago consulta = (MtFormaPago) st.get(MtFormaPago.class, id);
            if (consulta == null) {
                respuesta = true;
            } else {
                respuesta = false;
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio un error al validar el Codigo. " + ex.getMessage(),
                    "Mantenimiento Forma de Pago", JOptionPane.ERROR_MESSAGE);
        }
        return respuesta;
    }
    ...
    public void informe() {
        try {            
            ...
            jviewer.setTitle("Lista de Formas de Pago.");
