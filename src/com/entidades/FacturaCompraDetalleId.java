...
/**
 * FacturaCompraDetalleId generated by hbm2java
 */
public class FacturaCompraDetalleId  implements java.io.Serializable {


     private int nroTrans;
     private int linea;

    public FacturaCompraDetalleId() {
    }

    public FacturaCompraDetalleId(int nroTrans, int linea) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FacturaCompraDetalleId) ) return false;
		 FacturaCompraDetalleId castOther = ( FacturaCompraDetalleId ) other; 
