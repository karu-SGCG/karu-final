...
public class Busqueda extends javax.swing.JDialog {
    ...
    public Busqueda(java.awt.Dialog parent, boolean modal, String titulo, String tabla, String colCodigo, String colDescripcion) {
        super(parent, modal);
        initComponents();
        sessionHibernate();
        arranque();
    ...
    private void cargarTabla() {
        ...
        if (!this.txtCriterio.getText().isEmpty()) {
            ...
            // Armo el query teniendo en cuenta el criterio seleccionado. Uso Upper para que no sea CaseSensitive.
